            ...
            <% loop $Posts %>
                <div class="default-blog-item">
                    <a href="{$Link}" class="default-blog-item__link">
                        <div class="default-blog-item__media" data-src="{$FeaturedImage.FocusFill(500,600).URL}">
                            <img src="{$FeaturedImage.Fill(5,6).URL}" width="5" height="6" loading="lazy" alt="{$Image.Title.ATT}">
