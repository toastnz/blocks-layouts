<colour-block id="{$BlockID}" tabIndex="0" class="default-media-text [ js-default-media-text ] theme-colour--{$PrimaryColour.ColourCustomID} {$IncludeClasses} {$ExtraClasses}">
    <section>
